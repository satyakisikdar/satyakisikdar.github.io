...
<div class="lab-logo">
  <img class="repo-img-light" src="{{ '/assets/img/lab-logo-light.png' | relative_url }}" alt="Sikdar Lab" width="840" height="181" loading="lazy" decoding="async">
  <img class="repo-img-dark" src="{{ '/assets/img/lab-logo-dark.png' | relative_url }}" alt="Sikdar Lab" width="840" height="181" loading="lazy" decoding="async">
</div>
